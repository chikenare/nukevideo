...
// by NODE_TYPE: worker nodes run only the video supervisor; the main server runs only
// the default-queue supervisor and must never pull `video-processing` (it isn't a worker
