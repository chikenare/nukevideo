...
| `API_UPSTREAM_HOST` | `nukevideo-api:8080` | API server hostname:port. The proxy derives `API_UPSTREAM` (with scheme) from this automatically. |
...
3. Sends bandwidth data to ClickHouse for analytics.
