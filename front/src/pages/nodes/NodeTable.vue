...
import { Box, EllipsisVertical, Pencil, Rocket, ScrollText, Trash2 } from 'lucide-vue-next'
...
<template>
  <div class="overflow-hidden rounded-lg border">
    ...
    <DeployConfirmDialog ref="deployDialog" @node-updated="(node) => emit('updated', node)" />
